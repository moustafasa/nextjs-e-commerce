...
export default async function ShopNowSideNavSk() {
  return (
    <div className="text-white md:fixed md:top-nav-h md:bg-black-nav md:w-shop-now-side-nav-w md:left-0 md:h-full z-30">
